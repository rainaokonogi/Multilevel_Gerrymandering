...
def main():
    ...
    for N in [6, 12, 24]:
        BASE_DIR = f"{CURRENT_WORKING_DIRECTORY}/REP_DATA/6-12-24_grid_results/{N}x{N}_grid_results/NG/output_updaters/toward_D/"
        OUT_DIR = Path(f"{CURRENT_WORKING_DIRECTORY}/6-12-24_grid_results/processed_results_data_(replicated)/{N}x{N}_grid_results/NG/NG_maximums")
