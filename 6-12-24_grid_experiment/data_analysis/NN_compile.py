...
def main():
    ...
    for N in [6, 12, 24]:
        ...
        BASE_DIR = f"{CURRENT_WORKING_DIRECTORY}/REP_DATA/6-12-24_grid_results/{N}x{N}_grid_results/NN/output_updaters/"
        OUT_DIR = f"{CURRENT_WORKING_DIRECTORY}/6-12-24_grid_experiment/6-12-24_grid_experiment_results_(replicated)/{N}x{N}_grid_results/NN/compiled_results/"
