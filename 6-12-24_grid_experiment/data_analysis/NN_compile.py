...
for grid_size in [24]:
    BASE_DIR = f"{CURRENT_WORKING_DIRECTORY}/REP_DATA/6-12-24_grid_results/{grid_size}x{grid_size}_grid_results/NN/output_updaters"
    OUT_DIR = f"{CURRENT_WORKING_DIRECTORY}/REP_DATA/6-12-24_grid_exp/{grid_size}x{grid_size}_grid_results/NN_compiled/"
    ...
    for run_folder in os.listdir(BASE_DIR):
        ...
        for block_folder in os.listdir(run_path):
            ...
            out_name = f"{run_folder}_{block_folder}.jsonl"
