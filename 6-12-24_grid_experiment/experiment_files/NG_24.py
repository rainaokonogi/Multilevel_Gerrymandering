...
def run_experiment_ng_24(assort_score, num_r_units, map_number, block_size, init_part, random_seed, burst_length, total_steps):
    ...
    for sample in range(1,101):
        ...
        save_assignment_results_to = (
            f"/share/duchin/raina/REP_DATA/6-12-24_grid_results/24x24_grid_results/NG/output_ensembles/toward_R/{assort_score}_BR_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
        ...
        save_updaters_results_to = (
            f"/share/duchin/raina/REP_DATA/6-12-24_grid_results/24x24_grid_results/NG/output_updaters/toward_R/{assort_score}_BR_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
