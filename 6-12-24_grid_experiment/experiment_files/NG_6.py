...
def run_experiment_ng(num_r_units, block_size, init_part, random_seed, burst_length, total_steps):
    ...
    underlying_map = (
        f"{CURRENT_WORKING_DIRECTORY}/6-12-24_grid_experiment/grids_and_blocks/grid_maps/6x6_units_maps/grids_.jsons/"
    ...
    for sample in range(1,101):
        ...
        save_assignment_results_to = (
            f"{CURRENT_WORKING_DIRECTORY}/REP_DATA_(replicated)/6-12-24_grid_results/6x6_grid_results/NG/output_ensembles/toward_{party}/med_BR_score_r_units_{num_r_units}_map_1/block_size_{block_size}/"
        ...
        save_updaters_results_to = (
            f"{CURRENT_WORKING_DIRECTORY}/REP_DATA_(replicated)/6-12-24_grid_results/6x6_grid_results/NG/output_updaters/toward_{party}/med_BR_score_r_units_{num_r_units}_map_1/block_size_{block_size}/"
        ...
        block_data = (
            f"{CURRENT_WORKING_DIRECTORY}/6-12-24_grid_experiment/grids_and_blocks/6_block_partitions/"
        ...
        # 36 nodes and 6 districts, so pop_target is 6
        proposal = partial(
            recom,
            pop_col=pop_col,
            pop_target=6,
