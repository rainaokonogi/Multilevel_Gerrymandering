...
def run_experiment_ng_6(assort_score, num_r_units, map_number, block_size, init_part, random_seed, burst_length, total_steps):
    ...
    underlying_map = (
        f"/share/duchin/raina/6-12-24_grid_exp/6x6_unit_maps/map_.jsons/"
    ...
    for sample in range(1,101):
        ...
        save_assignment_results_to = (
            f"/share/duchin/raina/6-12-24_grid_exp/6_results_ensembles/NG/toward_D/{assort_score}_BR_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
        ...
        save_updaters_results_to = (
            f"/share/duchin/raina/6-12-24_grid_exp/6_results_updaters/NG/toward_D/{assort_score}_BR_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
        ...
        block_data = (
            f"/share/duchin/raina/6-12-24_grid_exp/6_block_partitions/"
