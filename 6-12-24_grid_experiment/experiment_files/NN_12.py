...
def run_experiment_nn_12(assort_score, num_r_units, map_number, block_size, init_part, random_seed, total_steps):
    ...
    for sample in range(1,101):
        ...
        save_assignment_results_to = (
            f"/share/duchin/raina/6-12-24_grid_exp/12_results_ensembles/NN/{assort_score}_BR_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
        ...
        save_updaters_results_to = (
            f"/share/duchin/raina/6-12-24_grid_exp/12_results_updaters/NN/{assort_score}_BR_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
