...
def make_block_size_1_building_blocks():
    ...
    grid_dual_graph_file = f"/share/duchin/raina/6-12-24_grid_exp/24x24_unit_maps/map_.jsons/24_by_24_grid_no_votes.json"
    ...
    for i in range(n_samples):
        save_to_file = (
            f"/share/duchin/raina/6-12-24_grid_exp/24_block_partitions/block_size_1/sample_{i+1}.json"
        )
