...
def make_12_blocks(block_size):
    ...
    grid_dual_graph_file = (
        f"/share/duchin/raina/6-12-24_grid_exp/12x12_unit_maps/map_.jsons/12_by_12_grid_no_votes.json"
    )
    ...
    for i in range(len(samples)):
        ...
        save_to_file = (
            f"/share/duchin/raina/6-12-24_grid_exp/12_block_partitions/block_size_{block_size}/sample_{i+1}.json"
        )
