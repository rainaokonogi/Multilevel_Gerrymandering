...
def make_6_blocks(block_size):
    ...
    grid_dual_graph_file = (
        f"/share/duchin/raina/6-12-24_grid_exp/6x6_unit_maps/map_.jsons/6_by_6_grid_no_votes.json"
    )
    ...
    for i in range(len(samples)):
        ...
        save_to_file = (
            f"/share/duchin/raina/6-12-24_grid_exp/6_block_partitions/block_size_{block_size}/sample_{i+1}.json"
        )
