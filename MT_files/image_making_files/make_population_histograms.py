...
def main():
    ...
    for block_type in ["vtds", "blockgroups", "tracts"]:
        graph = Graph.from_json(f"{CURRENT_WORKING_DIRECTORY}/MT_files/dual_graphs/MT_{block_type}_dual_graph.json")
        ...
        save_location = f"{CURRENT_WORKING_DIRECTORY}/image_replication/MT_unit_population_images/MT_{block_type}_populations.png"
