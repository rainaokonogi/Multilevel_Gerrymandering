...
with open("/share/duchin/raina/REPLICATION_REPO/MT_results/gerry_max_and_min_values/gerry_D_POV/A_gerry_toward_D_using_pres_data_pres.jsonl",'r') as f:
...
with open("/share/duchin/raina/REPLICATION_REPO/MT_results/gerry_max_and_min_values/gerry_R_POV/A_gerry_toward_R_using_pres_data_pres.jsonl",'r') as f:
    for i, line in enumerate(f):
        data = json.loads(line)
        info = data["Min Vals"]
...
plt.tight_layout()
plt.savefig("/share/duchin/raina/Montana_files/A_paper_images_compiled_2/MT_TEST_PRES_IMAGE.png",dpi=600)