...
# Output folder
output_file = "/share/duchin/raina/REPLICATION_REPO/NY_files/processed_results_data/gerry_max_and_min_values/gerry_toward_R_using_pres_data.jsonl"
...
for geo_type in ["vtds", "blockgroups", "tracts"]:
    ...
    for exp_folder in geo_path.iterdir():
        ...
        print(f"Saved {geo_type} -> {exp_name} pres mins to {output_file}")