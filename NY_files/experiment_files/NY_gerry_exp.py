...
def NY_gerry_exp(block_type, election, party, init_part, random_seed, burst_length, total_steps):
    """Runs one optimized search of New York redistricting plans.
    ...
    Args:
        ...
        election (str): choice of election data used to determine winners of districts,
            either "pres" for the 2020 Presidential election or "sen" for the 2022 U.S. Senate election.
    ...
    save_assignment_results_to = (
        f"{CURRENT_WORKING_DIRECTORY}/REP_DATA_(replicated)/New_York_results/gerry/gerry_ensembles/{block_type}/"
    ...
    save_updaters_results_to = (
        f"{CURRENT_WORKING_DIRECTORY}/REP_DATA_(replicated)/New_York_results/gerry/gerry_updaters/{block_type}/"
        f"gerry_toward_{party}_using_{election}_data/"
