...
# Neutral data
blockgroup_data = np.load("/share/duchin/raina/Montana_files/saved_histograms/NY/neutral_pres_blockgroups_histogram.npy", allow_pickle=True)
...
plt.tight_layout()
plt.savefig("/share/duchin/raina/Montana_files/A_paper_images_compiled_2/NY_PRES_TEST_IMAGE.png",dpi=600)