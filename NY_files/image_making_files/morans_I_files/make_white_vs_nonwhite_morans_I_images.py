...
def make_image(block_type):
    ...
    file_to_open = f"{CURRENT_WORKING_DIRECTORY}/NY_files/dual_graphs/morans_i_graphs/white_v_nonwhite/NY_{block_type}_dual_graph_{election}_for_moran.json"
    with open(file_to_open) as f:
        ...
        plt.tight_layout()
        save_location = f"{CURRENT_WORKING_DIRECTORY}/image_replication/NY_morans_i_images//NY_white_v_nonwhite_{election}_{block_type}_morans_i.png"
