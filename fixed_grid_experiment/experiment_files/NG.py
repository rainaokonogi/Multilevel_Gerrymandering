...
def run_experiment_ng(assort_score, num_r_units, map_number, block_size, init_part, random_seed, burst_length, total_steps):
    ...
    underlying_map = (
        f"{CURRENT_WORKING_DIRECTORY}/fixed_grid_experiment/grids_and_blocks/grid_maps/grids_.jsons/"
    ...
    for sample in range(1,101):
        ...
        save_assignment_results_to = (
            f"{CURRENT_WORKING_DIRECTORY}/REP_DATA_(replicated)/12x12_grid_results/NG/output_ensembles/toward_{party}/{assort_score}_BR_score_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
        ...
        save_updaters_results_to = (
            f"{CURRENT_WORKING_DIRECTORY}/REP_DATA_(replicated)/12x12_grid_results/NG/output_updaters/toward_{party}/{assort_score}_BR_score_r_units_{num_r_units}_map_{map_number}/block_size_{block_size}/"
        ...
        block_data = (
            f"{CURRENT_WORKING_DIRECTORY}/fixed_grid_experiment/grids_and_blocks/block_partitions/neutral/"
