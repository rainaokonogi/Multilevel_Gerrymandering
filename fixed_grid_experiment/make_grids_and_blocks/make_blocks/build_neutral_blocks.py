...
def main():
    ...
    for block_size in [2, 3, 4, 6]:
        ...
        grid_dual_graph_file = (
            f"{CURRENT_WORKING_DIRECTORY}/fixed_grid_experiment/grids_and_blocks/grid_maps/grids_.jsons/12x12_grid_no_votes.json"
        )
        ...
        # Define a ReCom chain of 1,000,000 steps making new building block partitions
