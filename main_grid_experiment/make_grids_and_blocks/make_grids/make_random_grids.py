...
def create_dual_graph(num_r_units, map_number):
    ...
    """
    save_grid_maps_to = (
        f"/share/duchin/raina/syn_files/syn_unit_maps/map_.jsons/r_units_{num_r_units}_map_{map_number}.json"
    )
...
def create_dual_graph_image(num_r_units, map_number):
    ...
    # )
    save_grid_map_images_to = f"/share/duchin/raina/syn_extra_unit_maps/map_.pngs/clustered_r_units_{num_r_units}_map_{map_number}.png"
    ...
    # )
    unit_dual_graph_json = f"/share/duchin/raina/syn_extra_unit_maps/map_.jsons/clustered_r_units_{num_r_units}_map_{map_number}.json"
